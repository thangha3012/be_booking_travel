        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefType = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DepartureSchedules_Tours_TourId",
                        column: x => x.TourId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_DepartureSchedules_DepartureScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourPricings_DepartureSchedules_DepartureScheduleId",
                        column: x => x.DepartureScheduleId,
                        principalTable: "DepartureSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_DepartureScheduleId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartureSchedules_TourId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourPricings_DepartureScheduleId",
                table: "TourPricings",
                column: "DepartureScheduleId");
